...
namespace Souvenir
{
    ...
    public static class AnswerGenerator
    {
        ...
        ///     [AnswerGenerator.Ordinal(1, 50, 10)] //Generates ordinals that are multiples of 10 between 1 and 50 inclusive.
        ///     [AnswerGenerator.Ordinal(2, 5)] //Generates ordinals "second", "third", "fourth", and "fifith" in the target language
        /// </code>
        /// </example>
        /// </summary>
